...
namespace geom {	
	...
	struct shape { 
		...
		virtual bool calc_interception(ray& theray, const nicefp within_d, interception& out);
	...
	struct triangle: shape {
		...
		virtual bool calc_interception(ray& theray, const nicefp within_d, interception& out) override; 
